...
\vspace{3pt}
\begin{center}
    Based on  \href{https://arxiv.org/abs/2409.10564}{\color{jyublue}\texttt{[2409.10564]}$^\text{\scalebox{0.9}{\faExternalLink}}$}, \href{https://arxiv.org/abs/2409.10565}{\color{jyublue}\texttt{[2409.10565]}$^\text{\scalebox{0.9}{\faExternalLink}}$} (accepted to PRL and PRD)
\end{center}
% \vspace{10pt}
}
...
\begin{frame}[plain,noframenumbering]{}
    \begin{center}
        ...
        {\large\textit{Candidates: $R_{AA}$, $C(\Delta\phi)$, others?}}
    \end{center}
    % \begin{tikzpicture}[overlay, remember picture]
    %     \node[anchor=north west] 
    %     at ([xshift=0.05cm,yshift=-0.05cm]current page.north west) {\begin{talkbox}\scriptsize{\color{destacado}Greco$\hspace{1pt}^\text{\scalebox{0.9}{\faComment}}$} {\itshape Tue 15:15$\hspace{1pt}^\text{\scalebox{0.9}{\faClockO}}$} \end{talkbox}};
